...
import com.sesac.aibackend.sp03_security_rag.dto.RagChatRequest;
import com.sesac.aibackend.sp03_security_rag.dto.RagIngestResponse;
import com.sesac.aibackend.sp03_security_rag.service.PythonRagClient;
...
public class RagController {
    ...
    public RagIngestResponse ingest(
        ...
        RagIngestResponse response = ragClient.ingest(file.getBytes(), file.getOriginalFilename()).block(); // 던질때는 byte 형태로 보내줘야 한다 (다른 형식이 안되서)
        if (response == null) {
