...
import com.sesac.aibackend.sp01_restapi.error.ErrorResponse;
 ...
 */
@Component
public class RestAuthenticationEntryPoint implements AuthenticationEntryPoint { // 체인에 걸어줄 핸들러.
    // 401번 에러가 났을때 보내줄 핸들러
